...
import * as dataSource from '../../datasource/OrderFormDataSource';
...
class OrderForm extends React.Component {
    ...
    getBannerSection() {
        const serviceTitle = this.props.serviceTitle || ""
        const serviceDescription = this.props.description || dataSource.getDescriptionForServiceTitle(serviceTitle)
    ...
    render() {
        const { visible, onCancel, serviceTitle, form } = this.props;
                                ...
                                return (
                                    <Form.Item label={formLabel(question)}>
                                        {getFieldDecorator(key, {
                                            ...
                                            <Input placeholder={"Type response here..."} size={inputSize} disabled={confirmLoading} />
                                        )}
                                    </Form.Item>
                                );
                                ...
                                return (
                                    <Form.Item label={formLabel(question)}>
                                        {getFieldDecorator(key, {
                                            ...
                                            <TextArea placeholder={"Type response here..."} size={inputSize} rows={4} disabled={confirmLoading} />
                                        )}
                                    </Form.Item>
                                );
